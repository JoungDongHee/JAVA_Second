...
//        System.out.println("새로운 시리얼 넘버를 발급 받았습니다. : "+ this.serialNumber);
    ...
    BalckBox(String modelName , String resolution ,int price , String color){
//        this(); // 기본 생성자 호출
...
//        this.color = color;
    ...
    void record(boolean showDateTime , boolean showSpeed , int min){
        ...
        if(showSpeed){
            System.out.println("영상에 속도정부가 표시됩니다.");
        }
    ...
    static void callSserviceCenter(){
        System.out.println("서비스 센터(1588-00000)로 연결합니다.");
    }
